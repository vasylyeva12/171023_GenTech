// Создать коллекцию workers.
// Заполнить коллекцию workers 5 документами со свойствами _id, firstname, lastname, age, position, salary, skills. Используйте следующие данные:
    ...
    db.workers.insertMany([{
        ...
        salary:1500, 
        skills: 
            ['preparing drinks', 'cleaning equipment']
    ...
    db.workers.find()  //чтобы извлечь документы из коллекции

    db.workers.find({firstname: 'Olga'})
...
db.users.find( { 
    ...
    firstname: {$in:['Анатолий', 'Дмитрий', 'Ольга', 'Семен']}
